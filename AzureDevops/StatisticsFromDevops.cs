...
{
    internal class StatisticsFromDevops : Devops
    {
        private WorkItemTrackingHttpClient witClient;
        public StatisticsFromDevops(ILogger<Devops> log, IConfiguration config) : base(log, config) {}
    ...
    public override void Run()
        ...
        {
            //https://dev.azure.com/skanskanordic/_usersSettings/tokens
